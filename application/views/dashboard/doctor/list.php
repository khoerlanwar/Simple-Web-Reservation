                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card">
                                                      ...
                                                      <tbody>
                                                        <?php $i=1; foreach($data as $row) { ?>
                                                            <tr>
                                                              ...
                                                              <td>
                                                                <?php if ($row['dctStatus'] == 0 ) { ?>
                                                                    <span class="badge bagde-sm bg-danger">In Active</span>
                                                                <?php } else { ?>
                                                                    <span class="badge bagde-sm bg-primary">Active</span>
                                                                <?php }?>
                                                              </td>
                                                              <td><?php echo $row['dctCreateTime'] ?></td>
                                                              <td>
                                                                <a href="<?php echo base_url('/doctor/edit?id=' . $row['dctId']) ?>" class="btn btn-sm btn-success"><i class="far fa-edit"></i></a>
                                                                <a href="<?php echo base_url('/doctor/delete?id=' . $row['dctId']) ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                            </td>
                                                            </tr>
                                                        <?php $i++; } ?>
                                                      </tbody>
                                                ...
                                                <div class="card-footer">
                                                     <a href="<?php echo base_url('/doctor/add') ?>" class="btn btn-primary">Add Doctor</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 

                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <form action="<?php echo base_url('doctor/postEdit') ?>" method="post">
                                                    <div class="card-body">
                                                        <input type="hidden" name="dctId" value="<?php echo $data->dctId ?>">
                                                        <div class="form-group">
                                                            <label>Doctor Name</label><span><i>*</i></span>
                                                            <input type="text" name="dctFullname" class="form-control" placeholder="Doctor Name" value="<?php echo $data->dctFullname ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Status Doctor</label>
                                                            <select class="form-control" name="dctStatus" width="100%">
                                                                <option value="0" <?php echo ($data->dctStatus == 0)? 'selected': true; ?>>In Active</option>
                                                                <option value="1" <?php echo ($data->dctStatus == 1)? 'selected': true; ?>>Active</option>
                                                            </select>
                                                        </div>
                                                    </div>

                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card">
                                                      ...
                                                      <tbody>
                                                        <?php $i=1; foreach($data as $row) { ?>
                                                            <tr>
                                                              ...
                                                              <td>
                                                                  <?php if ($row['psnGender'] == 1 ) { ?>
                                                                    <span>Man</span>
                                                                <?php } else if ($row['psnGender'] == 2 ) { ?>
                                                                    <span>Women</span>
                                                                <?php } else { ?>
                                                                    <span>Other</span>
                                                                <?php }  ?>
                                                              ...
                                                              <td>
                                                                <?php if ($row['psnStatus'] == 0 ) { ?>
                                                                    <span class="badge bagde-sm bg-danger">In Active</span>
                                                                <?php } else { ?>
                                                                    <span class="badge bagde-sm bg-primary">Active</span>
                                                                <?php }?>
                                                              </td>
                                                              <td><?php echo $row['psnAddress'] ?></td>
                                                              <td><?php echo $row['psnTglLahir'] ?></td>
                                                              <td>
                                                                <a href="<?php echo base_url('/patient/edit?id=' . $row['psnId']) ?>" class="btn btn-sm btn-success"><i class="far fa-edit"></i></a>
                                                                <a href="<?php echo base_url('/patient/delete?id=' . $row['psnId']) ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                            </td>
                                                            </tr>
                                                        <?php $i++; } ?>
                                                      </tbody>
                                                ...
                                                <div class="card-footer">
                                                     <a href="<?php echo base_url('/patient/add') ?>" class="btn btn-primary">Add Patient</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 

                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <form action="<?php echo base_url('reservation/postAdd') ?>" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <span class="text-xs"><i>*If patient not found, the patient is not registrated. click button for add new patient</i></span>
                                                            <a href="<?php echo base_url('/patient/add') ?>" class="btn btn-sm   btn-block btn-primary">Add New Patient</a>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="rsvReserveDate" class="form-control float-right reservationtime" placeholder="Select Date & Time">
                                                            </div>
                                                        </div>
                                                    </div> 
